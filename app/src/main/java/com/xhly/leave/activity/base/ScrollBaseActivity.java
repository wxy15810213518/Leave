...
import com.xhly.leave.adapter.SimpleHeaderRecyclerAdapter;
import com.xhly.leave.adapter.SimpleRecyclerAdapter;

import java.util.ArrayList;

/**
 * Created by 新火燎塬 on 2016/7/3. 以及  on 16:21!^-^
 */
public class ScrollBaseActivity extends AppCompatActivity {
    ...
    protected void setDummyDataWithHeader(ArrayList data ,RecyclerView recyclerView, View headerView) {
        recyclerView.setAdapter(new SimpleHeaderRecyclerAdapter(this, data, headerView));
    }
}
